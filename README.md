...
Click the following url to register : [https://t.me/blum/app?startapp=ref_qxtisHh7Fc](https://t.me/blum/app?startapp=ref_qxtisHh7Fc)
...
2. Clone this repository
   ```shell
   git clone https://github.com/nialthony/Blumtidur.git
   ```
